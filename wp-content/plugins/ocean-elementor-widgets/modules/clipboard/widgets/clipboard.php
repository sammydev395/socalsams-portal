...
class Clipboard extends Widget_Base {
	...
	protected function render() {
		...
		<div class="oew-clipboard-wrapper oew-clipboard-wrapper-textarea">
			<button <?php echo $this->get_render_attribute_string( 'clipboard-button' ); ?>>
			...
			<textarea <?php echo $this->get_render_attribute_string( 'clipboard-value' ); ?>><?php echo esc_attr( $settings['text'] ); ?></textarea>
		</div>
		<?php
	}
}
