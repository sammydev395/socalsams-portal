...
final class Ocean_Sticky_Header {
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting(
			'osh_header_tablet_right_padding',
			array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'oceanwp_sanitize_number_blank',
			)
		...
		$wp_customize->add_setting(
			'osh_header_tablet_bottom_padding',
			array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'oceanwp_sanitize_number_blank',
			)
		...
		$wp_customize->add_setting(
			'osh_header_tablet_left_padding',
			array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'oceanwp_sanitize_number_blank',
			)
		...
		$wp_customize->add_setting(
			'osh_header_mobile_right_padding',
			array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'oceanwp_sanitize_number_blank',
			)
		...
		$wp_customize->add_setting(
			'osh_header_mobile_bottom_padding',
			array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'oceanwp_sanitize_number_blank',
			)
		...
		$wp_customize->add_setting(
			'osh_header_mobile_left_padding',
			array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'oceanwp_sanitize_number_blank',
			)
